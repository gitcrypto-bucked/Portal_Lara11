                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-0 pb-0">
                            ...
                            <div class="d-flex justify-content-center text-center mt-4 pt-1">
                                <a href="https://www.instagram.com/lowcost_official/" target="_blank" class="text-white"><img src="{{asset('assets/social/instagram.png')}}" class="linkedin px-2"></a>
                                <a href="https://www.linkedin.com/company/lowcost/mycompany/"  target="_blank" class="text-white"><img src="{{asset('assets/social/linkedin.png')}}" class="linkedin px-2"></i></a>
                                <a href="https://web.facebook.com/lowcostoficial/?_rdc=1&_rdr" target="_blank" class="text-white"><img src="{{asset('assets/social/facebook.png')}}" class="linkedin px-2"></a>
                            </div>
